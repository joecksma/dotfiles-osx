...
#TODO This breaks system settings...
NOT_USED=""
read -p "Waiting for user to grant accessability permissions...: " NOT_USED
echo "Changing some ridiculous defaults..."
# # Thanks to Mathias Bynens!
# # ~/.macos — https://mths.be/macos


# # Close a ny open System Preferences panes, to prevent them from overriding settings we’re about to change
osascript -e 'tell application "System Preferences" to quit'
# disable sp otlight indexing
sudo mdutil -i off
...
echo "Done! Note that some of these changes require a restart to take effect. Until then the preferences app may be broken."